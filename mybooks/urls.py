...
from mybooks import core_views, oauth_dcr_view, oauth_views
...
urlpatterns = [
    ...
    path("oauth/register/", oauth_dcr_view.DynamicClientRegistrationView.as_view(), name="oauth-register"),
    path(".well-known/oauth-authorization-server", oauth_views.oauth_auth_server_metadata, name="oauth-auth-server-metadata"),
    path(
    ...
    path("oauth-apps-authorize/<str:client_id>/", oauth_views.authorize, name="oauth-apps-authorize"),
