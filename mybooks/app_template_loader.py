    ...
    for app in settings.INSTALLED_APPS:
        if app.split(".")[-1] == app_name:
            ...
            if mod.__file__ is not None:
                template_dir = join(abspath(dirname(str(mod.__file__))), "templates")
            break
...
if django.VERSION >= (1, 9):
    ...
    def get_template_path(template_dir, template_name, loader=None):  # pylint: disable=unused-argument
