...
LOGGING = {
    ...
    "handlers": {
        "console": {
            "level": "INFO",  # Keep console clean with INFO level
...
if DEBUG:
    LOGGING["loggers"].update(
        {
            "mybooks.oauth_debug_middleware": {
                "handlers": ["file"],  # OAuth2 debug middleware logs to file
                "level": "DEBUG",
                "propagate": False,
            },
            "mybooks.oauth_views": {
                "handlers": ["file"],  # OAuth views (including DCR) logs to file
                "level": "DEBUG",
                "propagate": False,
            },
            "oauth2_provider": {
                "handlers": ["file"],  # Django OAuth Toolkit internal logs to file
                "level": "DEBUG",
                "propagate": False,
            },
            "rest_framework": {
                "handlers": ["file"],  # DEBUG logs only to file, not console
                "level": "DEBUG",
                "propagate": False,
            },
            "django.contrib.auth": {
...
OAUTH2_PROVIDER = {
    ...
    # AIDEV-NOTE: Hash client secrets for security (custom DCR view handles plain text response)
