...
dev-server:
    doppler run --project mybooks --config server -- uv run manage.py runserver_plus 0.0.0.0:8080
...
export-api-spec:
    ...
    doppler run -- uv run manage.py spectacular --file openapi/mybooks.yaml --format openapi
