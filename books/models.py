...
class UserBook(models.Model):
    ...
    date_started = models.DateTimeField(blank=True, null=True, help_text="When user started reading")
    date_finished = models.DateTimeField(blank=True, null=True, help_text="When user finished reading")
